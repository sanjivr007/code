...
public class ContextMachine {
	...
	public void execute() {
		...
		for (HashMap<String, Integer> map : questionScore) {
			...
			matchingtext = getMatchingTestMap(map);
	...
	private HashMap<String, Integer> getMatchingTestMap(HashMap<String, Integer> map) {
	...
	private int getAnswerIndex(HashMap<String, Integer> matchingtext, boolean visited[]) {
		int ansScore = 0;
